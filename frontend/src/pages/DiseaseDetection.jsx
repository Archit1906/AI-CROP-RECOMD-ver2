  ...
  return (
    <div style={{ padding:24, background:'#0A0A0F', minHeight:'100vh' }}>
      ...
      {history.length > 0 && (
        <button onClick={() => setShowHistory(!showHistory)}
          style={{ marginBottom:16, padding:'8px 16px',
                   background: showHistory ? '#FF660022' : 'transparent',
            ...
            return (
              <div key={entry.id}
                ...
                style={{ flex:1, background:'#0D0D1A',
                         border:`1px solid ${hInfo?.threatColor || '#FF6600'}44`,
                         borderRadius:2, padding:'12px', cursor:'pointer',
                         transition:'all 0.15s' }}
                onMouseEnter={e => e.currentTarget.style.borderColor=hInfo?.threatColor||'#FF6600'}
                onMouseLeave={e => e.currentTarget.style.borderColor=`${hInfo?.threatColor||'#FF6600'}44`}>
                <div style={{ display:'flex', gap:10, alignItems:'center' }}>
                  {entry.image && (
                    <img src={entry.image} alt=""
                      style={{ width:40, height:40, objectFit:'cover',
                               borderRadius:2, border:'1px solid #FF660033' }} />
                  )}
                  <div>
                    <p style={{ fontFamily:"'Orbitron'", fontSize:10,
                                 color: hInfo?.threatColor || '#FF6600',
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16 }}>
        ...
        {/* LEFT — Upload panel */}
        <div style={{ background:'#0D0D1A', border:'1px solid #FF000033',
          ...
          <div
            ...
            style={{
              border:`2px dashed ${dragOver ? '#FF0033' : image ? '#FF003366' : '#FF000033'}`,
              borderRadius:2, padding:'16px',
              minHeight:220, cursor:'pointer',
              display:'flex', flexDirection:'column',
              alignItems:'center', justifyContent:'center',
              background: dragOver ? '#FF000011' : 'transparent',
              ...
              <>
                ...
                {loading && (
                  <div style={{
                    ...
                    background:'linear-gradient(180deg, transparent 45%, #FF000033 50%, transparent 55%)',
          ...
          {/* Scan animation phases */}
          {loading && (
            <div style={{ background:'#0A0A0F', border:'1px solid #FF000033',
          ...
          <button onClick={handleScan}
            ...
            style={{
              ...
              background: loading ? '#FF000011' :
                          (!image && !imageFile) ? '#1A0A0A' : '#FF000022',
              border:`1px solid ${loading ? '#FF000066' : (!image && !imageFile) ? '#FF000022' : '#FF0033'}`,
              color: loading ? '#FF000088' :
                     (!image && !imageFile) ? '#FF000033' : '#FF0033',
              fontFamily:"'Orbitron'", fontSize:12, fontWeight:700,
              letterSpacing:4, cursor: (!image && !imageFile) ? 'not-allowed' : 'pointer',
              borderRadius:2, transition:'all 0.2s',
              boxShadow: (!loading && image) ? '0 0 20px #FF003333' : 'none'
            }}
        ...
        <div style={{ background:'#0D0D1A', border:`1px solid ${result ? (info?.threatColor||'#FF0033')+'44' : '#FF000022'}`,
                      borderRadius:2, padding:'20px',
          ...
          {result && info && (
            <div>
              ...
              <div style={{
                background: isHealthy ? '#00FF4111' : '#FF000011',
              ...
              <div style={{ background:'#0A0A0F', border:'1px solid #FF000033',
                ...
                <div style={{ height:8, background:'#FF000011',
                    ...
                    {result.top3.slice(1).map((alt, i) => {
                      ...
                      return (
                        <div key={i} style={{ display:'flex', alignItems:'center',
                          ...
                          <div style={{ height:4, flex:1, background:'#FF000011', borderRadius:1 }}>
                  ...
                  <div style={{ display:'flex', justifyContent:'space-between', marginBottom:6 }}>
                    ...
                    <p style={{ fontFamily:"'Orbitron'", fontSize:12, fontWeight:700,
                                 color: info.spreadRisk > 80 ? '#FF0033' :
                                        info.spreadRisk > 50 ? '#FFD700' : '#00FF41',
                                 margin:0 }}>
                      {info.spreadRisk}%
                    </p>
                  </div>
                  <div style={{ height:6, background:'#FF000011', borderRadius:1 }}>
                    <div style={{
                      height:'100%', borderRadius:1,
                      width:`${info.spreadRisk}%`,
                      background: info.spreadRisk > 80 ? '#FF0033' :
                                  info.spreadRisk > 50 ? '#FFD700' : '#00FF41',
                      transition:'width 1s ease'
                    }} />
                  </div>
