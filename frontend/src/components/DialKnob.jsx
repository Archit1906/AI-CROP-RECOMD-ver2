...
export default function DialKnob({
  ...
  color = '#FF6600', onChange, size = 120
}) {
    ...
    <div style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:6 }}>
      ...
      <svg ref={svgRef} width={size} height={size}
        ...
        <circle cx={CX} cy={CY} r={R + 8} fill="none"
          stroke="#FF660011" strokeWidth={1} strokeDasharray="4 6" />

        {/* Track arc (background) */}
        <path d={describeArc(START_ANGLE, END_ANGLE, R)}
          fill="none" stroke="#FF660022" strokeWidth={8}
          strokeLinecap="round" />
        ...
        {(() => {
          ...
          return (
            <circle cx={tp.x} cy={tp.y} r={6}
              fill={arcColor} stroke="#0A0A0F" strokeWidth={2}
        ...
        <circle cx={CX} cy={CY + 26} r={3}
          fill={isOptimal ? '#00FF41' : '#FF660044'}
      ...
      <p style={{
        ...
        color: isOptimal ? '#00FF4188' : '#FF660055',
